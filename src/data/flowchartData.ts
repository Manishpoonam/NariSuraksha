    ...
    actionSteps: [
      ...
      },
      {
        ...
        title: {
          ...
          hi: 'राष्ट्रीय महिला आयोग (NCW) हेल्पलाइन 7827170170 पर संपर्क करें',
        },
        description: {
          en: 'NCW has dedicated cyber nodal officers who directly follow up with Director Generals of Police (DGPs) for swift action.',
          hi: 'NCW की स्पेशल साइबर सेल सीधे पुलिस महानिदेशक स्तर पर तेजी से कार्रवाई करवाती है।',
        },
        buttonLabel: {
          en: 'Call NCW (7827170170)',
          hi: 'NCW 7827170170 पर कॉल करें',
        },
        actionType: 'call',
        linkUrl: 'tel:7827170170',
      },
    ],
  },
  {

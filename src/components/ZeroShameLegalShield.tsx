...
export const ZeroShameLegalShield: React.FC<ZeroShameLegalShieldProps> = ({ 
  ...
  const shieldItems = [
    ...
    },
    {
      ...
      detail: isHindi 
        ? 'भारतीय नागरिक सुरक्षा संहिता (BNSS धारा 173 / CrPC 154) के तहत महिलाओं के खिलाफ डिजिटल या यौन उत्पीड़न के मामलों में बयान महिला पुलिस अधिकारी द्वारा ही दर्ज किए जाने का कानूनी अधिकार है। आप अनुरोध कर सकती हैं कि यह बयान आपके आवास, हॉस्टल या सुरक्षित स्थान पर सादे कपड़ों में दर्ज किया जाए।' 
        : 'Under Section 173 of Bharatiya Nagarik Suraksha Sanhita (BNSS 2023) and CrPC 154, any statement regarding digital or sexual harassment must be recorded by a woman police officer. You have the statutory right to request it be taken at your residence, hostel, or in plain clothes.',

...
export const RescueFooterSupport: React.FC<RescueFooterSupportProps> = ({
  ...
  const handleBrowseStateServices = (_targetState?: string) => {
    hapticAction();
    onNavigateToTab('state_cells', 'state-cyber-directory');
  };
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5 items-stretch">
        ...
        <div className="p-4 sm:p-5 rounded-2xl bg-white border border-[#E8E2DC] shadow-xs flex flex-col justify-between space-y-4 hover:border-[#D8CFCE] transition-colors">
          ...
          <div className="pt-2 border-t border-[#F0EBE6] flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
            <button
              type="button"
              onClick={() => onNavigateToTab('state_cells', 'state-cyber-directory')}
              className="flex-1 inline-flex items-center justify-center gap-1.5 px-3 py-2.5 rounded-xl bg-[#FAF8F3] hover:bg-[#F3EFEA] text-[#1A1A1A] border border-[#E8E2DC] text-xs font-semibold transition-all cursor-pointer active:scale-98 min-h-[40px]"
            >
              <Building2 className="w-3.5 h-3.5 shrink-0 text-[#0F6E56]" />

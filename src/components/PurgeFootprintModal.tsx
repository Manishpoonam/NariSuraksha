      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
        ...
        >
          ...
          <div className="flex items-start justify-between gap-3 border-b border-[#F0EBE6] pb-4">
            ...
            <button
              onClick={onClose}
              className="p-1.5 rounded-full hover:bg-[#F3EFEC] text-[#888] hover:text-[#111] transition-colors"
            >
              <X className="w-5 h-5" />
            </button>
          </div>
            ...
            <div className="space-y-4 text-xs sm:text-sm text-[#444] leading-relaxed">
              ...
              <div className="pt-2 flex flex-col sm:flex-row items-center gap-2">
                <button
                  ...
                  className="w-full sm:flex-1 py-3 px-4 bg-rose-600 hover:bg-rose-700 text-white rounded-full font-bold text-xs sm:text-sm transition-all shadow-sm cursor-pointer flex items-center justify-center gap-2 active:scale-98"
                >
                ...
                <button
                  ...
                  className="w-full sm:w-auto py-3 px-5 bg-[#F3EFEC] hover:bg-[#E8E2DC] text-[#2D2D2D] rounded-full font-semibold text-xs sm:text-sm transition-colors cursor-pointer"
                >
